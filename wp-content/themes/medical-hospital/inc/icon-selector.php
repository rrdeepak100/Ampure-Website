...
class Medical_Hospital_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'medical-hospital'); ?>">
                      </div>
                    <?php
                    $medical_hospital_font_awesome_icon_array = medical_hospital_font_awesome_icon_array();
                    foreach ($medical_hospital_font_awesome_icon_array as $medical_hospital_font_awesome_icon) {
                            $icon_class = $this->value() == $medical_hospital_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($medical_hospital_font_awesome_icon).'"></i>
                            <span class="medical-hospital-social-class">'.esc_attr($medical_hospital_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function medical_hospital_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'medical_hospital_customizer_script' );

if(!function_exists('medical_hospital_font_awesome_icon_array')){
    function medical_hospital_font_awesome_icon_array(){
